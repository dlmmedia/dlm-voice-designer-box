          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-6 lg:pr-8">
              <div className="flex lg:justify-start justify-center mb-6">
                <Image
                  src="/dlm-voice-designer-logo.png"
                  alt="DLM Voice Designer Logo"
                  width={1024}
                  height={1024}
              ...
              <div className="flex justify-center lg:hidden my-8">
                <div className="w-full max-w-2xl">
                  <Image
                    ...
                    alt="DLM Voice Designer Application Screenshot"
                    width={1920}
                    height={1080}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-8">
            <div className="w-full">
              <Image
                ...
                alt="DLM Voice Designer Screenshot 2"
                width={1920}
                height={1080}
                className="w-full h-auto rounded-lg shadow-lg"
              />
            ...
            <div className="w-full">
              <Image
                src="/assets/app-screenshot-1.webp"
                alt="DLM Voice Designer Screenshot 1"
                width={1920}
                height={1080}
                className="w-full h-auto rounded-lg shadow-lg"
              />
            ...
            <div className="w-full">
              <Image
                ...
                alt="DLM Voice Designer Screenshot 3"
                width={1920}
                height={1080}
                className="w-full h-auto rounded-lg shadow-lg"
              />
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-6 sm:mb-8">
            What is DLM Voice Designer?
          </h2>
          <div className="space-y-6 text-lg text-foreground/80 text-center">
            <p>
              DLM Voice Designer is a <strong>local-first voice cloning studio</strong> with DAW-like features
            ...
            <p>
              Unlike cloud services that lock your voice data behind subscriptions, DLM Voice Designer gives
            ...
            <div className="w-full max-w-5xl">
              ...
              >
                <source
                  ...
                  type="video/webm"
                  aria-label="DLM Voice Designer Demo Video"
                />
